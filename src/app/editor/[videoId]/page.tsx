...
export default function EditorPage() {
  ...
  // Show loading while Convex fetches the video
  if (video === undefined) {
    return (
  ...
  const videoUrl = video.playUrl ?? undefined;
        ...
        <div className="absolute top-0 left-0 h-full w-[75px] hover:w-[260px] transition-all duration-300 ease-in-out bg-[#0F0F23] flex flex-col items-stretch overflow-y-auto overflow-x-hidden border-r border-[#1a1a2e] scrollbar-hide py-4 group">
          ...
          <div className="px-3 mb-4">
            ...
            >
              ...
              <span className="truncate whitespace-nowrap ml-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-sm font-medium">
                Media Library
              </span>
            </button>
          </div>
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div className="h-14 bg-white border-b border-gray-200 flex items-center px-4 justify-between flex-shrink-0">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="font-semibold text-gray-700 truncate max-w-[300px]">
              {video.name}
            </span>
          </div>
